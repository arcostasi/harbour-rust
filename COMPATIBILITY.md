...
| Runtime | broad alpha baseline | core values, arrays, selected string/math/conversion builtins, and growing oracle-backed string edge-case coverage for trim, search, and replication behavior |
