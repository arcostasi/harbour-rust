...
| Preprocessor | curated advanced subset | `#define`, `#include`, `#command`, `#translate`, plus oracle-anchored gap baselines for optional-marker and stringify edge rules |
...
- advanced preprocessor cases with escaped-bracket optional replacements, dumb-stringify combinations, and reordered optional captures are now covered by focused oracle-backed gap fixtures but still diverge from the upstream baseline;
