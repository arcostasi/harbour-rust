...
#[test]
fn preprocesses_list_fields_off_reordered_fixture() {
    let root = fixture_path("list_fields_off_reordered_root.prg");
    let expected = fs::read_to_string(fixture_path("list_fields_off_reordered_root.out")).unwrap();
