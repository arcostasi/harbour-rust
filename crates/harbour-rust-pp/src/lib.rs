...
mod tests {
    ...
    #[test]
    fn expands_save_to_all_like_subset() {
        let source = SourceFile::new(
            PathBuf::from("main.prg"),
    ...
    #[test]
    fn expands_save_to_all_except_subset() {
        let source = SourceFile::new(
            PathBuf::from("main.prg"),
    ...
    #[test]
    fn expands_list_fields_destination_subset() {
        let source = SourceFile::new(
            PathBuf::from("main.prg"),
        ...
        assert_eq!(
            output.text,
            "__dbList( .F., { {|| a} }, .t., , , , , .F., .T.,  )\n__dbList( .F., { {|| a} }, .t., , , , , .F., .F., \"a\" )\n__dbList( .F., { {|| a},{|| b} }, .t., , , , , .F., .T.,  )\n__dbList( .F., { {|| a},{|| b},{|| (seek(a+b),c)} }, .t., , , , , .F., .F., \"a\" )\n"
        );
    }

    #[test]
    fn expands_list_fields_off_subset() {
        let source = SourceFile::new(
            PathBuf::from("main.prg"),
