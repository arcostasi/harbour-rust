...
3. focused `hb_gzCompressBound()` and `hb_gzCompress()` slices covering direct output, `@nResult`, numeric `nDstBufLen`, destination-buffer writeback, and documented compression limits;
