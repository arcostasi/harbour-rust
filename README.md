...
[Latest release](https://github.com/arcostasi/harbour-rust/releases/tag/0.7.0-alpha) | [All releases](https://github.com/arcostasi/harbour-rust/releases) | [Documentation](./docs/README.md) | [Contributing](./CONTRIBUTING.md)
...
- Latest pre-release: [0.7.0-alpha](https://github.com/arcostasi/harbour-rust/releases/tag/0.7.0-alpha)
